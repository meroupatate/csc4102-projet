...
\cmt{attributs}\\
$-$ id : int \\
$-$ premiereClef : au plus une @Clef \\
$-$ secondeClef : au plus une @Clef \\
\hline
\cmt{constructeur} \\
$+$ Badge()\\
%$+$ destructeur()\\
...
$-$ secondeClef : au plus une @Clef \\
\cmt{attributs <<~association~>>}\\
$-$ badge : au plus un @Badge \\
$-$ client : au plus un @Client \\
\hline
\cmt{constructeur} \\
$+$ Chambre()\\
%$+$ destructeur()\\
...
\textbf{Invariant de la classe Badge:} en attente || attribué
